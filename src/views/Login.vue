  ...
  <div class="login" id="box">
      ...
      <div id="c3">
          <form id="form" >
              ...
              <input id="account" name="account" tabindex="1" class="username" type="text" v-model="account" required autofocus placeholder="输入平台账户" />
              <p class="alert">平台密码：</p>
              <input id="psw" name="psw" tabindex="3" class="phone" type="password" v-model="psw" required placeholder="输入平台密码"/>
